<?
  ...
  class DB
  {
    ...
    function DB()
    {
      ...
      $this->vLink = mysql_connect("localhost", $this->sDbUser, $this->sDbPass) or die('Server connexion not possible.');
      mysql_select_db($this->sDbName, $this->vLink) or die('Database connexion not possible.');
