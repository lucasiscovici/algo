        ...
        return this.each(function () {
            ...
            var setHover = function (score) {
                ...
                if (h.data('width') != w) {
                    ...
                    var data = [((score * itemdata('step')) + itemdata('min')).toFixed(1)];
                ...
                if (!itemdata('wired')) {
                    ...
                    range.keyup(function (e) {
                        if (e.which == 38 || e.which == (ltr ? 39 : 37)) {
                            setSelection(Math.min(itemdata('value') + itemdata('step'), itemdata('max')).toFixed(1));
                        }
                        if (e.which == 40 || e.which == (ltr ? 37 : 39)) {
                            setSelection(Math.max(itemdata('value') - itemdata('step'), itemdata('min')).toFixed(1));
                        }
                    });
